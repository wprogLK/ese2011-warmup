...
public class EventsTest2 extends TestTemplate
{
	...
	@Test
	public App eventTest2() throws UsernameAlreadyExistException, UnknownUserException, AccessDeniedException, InvalidDateException, UnknownCalendarException, UnknownEventException
	{
		App app = new App();
	...
	@Given("eventTest2")
	public App newNameOfEventShouldBeAreWeDead(App app) throws AccessDeniedException, InvalidDateException, UnknownCalendarException, UnknownEventException, ParseException
	{
	...
	@Given("eventTest2")
	public App newStartDateOfEventShouldBe01_08_2011(App app) throws AccessDeniedException, InvalidDateException, UnknownCalendarException, UnknownEventException, ParseException
	{
		this.userAlpha.createNewCalendar("MyCalendar");
	...
	@Given("eventTest2")
	public App newEndDateOfEventShouldBe01_08_2011(App app) throws AccessDeniedException, InvalidDateException, UnknownCalendarException, UnknownEventException, ParseException
	{
		this.userAlpha.createNewCalendar("MyCalendar");
	...
	@Given("eventTest2")
	public App newVisibilityShouldBePublic(App app) throws AccessDeniedException, InvalidDateException, UnknownCalendarException, UnknownEventException, ParseException
	{
		this.userAlpha.createNewCalendar("MyCalendar");
	...
	@Given("eventTest2")
	public App newVisibilityShouldBePrivate(App app) throws AccessDeniedException, InvalidDateException, UnknownCalendarException, UnknownEventException, ParseException
	{
		this.userAlpha.createNewCalendar("MyCalendar");
